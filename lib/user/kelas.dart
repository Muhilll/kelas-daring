...
import 'package:kelas_daring/user/detail-kelas.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

class UserKelasPage extends StatefulWidget {
  @override
  _UserKelasPageState createState() => _UserKelasPageState();
}

class _UserKelasPageState extends State<UserKelasPage> {
  @override
                ...
                return KelasItem(
                  ...
                  onTap: () async {
                    final result = await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => UserDetailKelas(id: kelas.id)
                      ),
                    );
                    if (result == true) {
                      updateKelas();
