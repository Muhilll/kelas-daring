...
import 'package:kelas_daring/pemilik/kelas/detail-kelas.dart';
import 'package:kelas_daring/pemilik/kelas/buat-kelas.dart';
import 'package:kelas_daring/login_page.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

class KelasPagePemilik extends StatefulWidget {
  @override
  _KelasPagePemilikState createState() => _KelasPagePemilikState();
}
...
class _KelasPagePemilikState extends State<KelasPagePemilik> {
  ...
  Future<List<Kelas>> fetchKelas(BuildContext context) async {
    ...
    final String url = EndPoint.url + 'pemilik/get-kelas?id=${id}';
    try {
